...
from utils import load_data,test_performance,calculate_accuracy,train
import models



# Chargement des données et création des dictionnaires
sentences, pos_tags = load_data("UD_French-Sequoia/fr_sequoia-ud-train.conllu",pos=True)
...
train(model, data_loader, loss_function, optimizer, tag_to_ix)


test_sentences, test_pos_tags = load_data("UD_French-Sequoia/fr_sequoia-ud-test.conllu",pos=True)
...
test_performance(model, test_loader, loss_function, tag_to_ix)
